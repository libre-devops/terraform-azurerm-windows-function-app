output "default_hostnames" {
  ...
  value       = { for k, a in azurerm_windows_function_app.this : k => a.default_hostname }
}

output "function_app_ids" {
  description = "Map of app name to app id."
  value       = { for k, a in azurerm_windows_function_app.this : k => a.id }
}

output "function_app_ids_zipmap" {
  description = "Map of app name to { name, id } for easy composition."
  value       = { for k, a in azurerm_windows_function_app.this : k => { name = a.name, id = a.id } }
}
...
output "identity_principal_ids" {
  ...
  value = {
    for k, a in azurerm_windows_function_app.this : k => {
...
output "possible_outbound_ip_address_lists" {
  ...
  value       = { for k, a in azurerm_windows_function_app.this : k => a.possible_outbound_ip_address_list }
}
