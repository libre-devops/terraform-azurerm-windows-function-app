output "function_app_identities" {
  ...
  value = {
    for key, value in azurerm_windows_function_app.function_app : key =>
...
output "function_apps_default_hostnames" {
  ...
  value       = { for app in azurerm_windows_function_app.function_app : app.name => app.default_hostname }
}

output "function_apps_outbound_ip_addresses" {
  description = "The outbound IP addresses of the windows Function Apps."
  value       = { for app in azurerm_windows_function_app.function_app : app.name => app.outbound_ip_addresses }
}
...
output "function_apps_possible_outbound_ip_addresses" {
  ...
  value       = { for app in azurerm_windows_function_app.function_app : app.name => app.possible_outbound_ip_addresses }
}
...
output "windows_function_apps_ids" {
  description = "The IDs of the windows Function Apps."
  value       = { for app in azurerm_windows_function_app.function_app : app.name => app.id }
}
