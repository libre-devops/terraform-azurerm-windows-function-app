variable "function_apps" {
  description = <<-DESC
    Windows function apps keyed by name. Fast to get going: an entry with just an
...
variable "service_plans" {
  description = <<-DESC
    ...
    defaults to Y1 (Windows consumption); anything the platform supports is accepted (B1/S1/P1v3
